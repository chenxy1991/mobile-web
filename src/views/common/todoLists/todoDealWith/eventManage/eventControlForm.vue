...
<div class="eventControlForm">
  <div  class="reset-cell" style="font-size: 1.4rem;background-color:rgb(242,243,238);">
    <header class="head">
     ...
     <main>
    <article>
    <!-- <article style="position:absolute;top: 4.4rem;left: 0;right: 0;"> -->
      <group :gutter="0" >
			<cell
				:title="('路由选择')"
				is-link
     ...
     <group :gutter="10" v-show="showSendDiv">
         ...
         <img style="display: inline-block;width: 20px;" src="../../../../../assets/images/icon/request.svg" slot="icon">
            ...
            <div v-for="(selectedSend,idx) in selectedSendList" :key="idx">
              <div style="background-color: #ffffff;padding: 0.5rem 1.5rem;line-height: 2.5rem;padding-bottom:4.6rem">
