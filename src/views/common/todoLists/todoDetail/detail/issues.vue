...
export default {
 ...
 created: function () {
    ...
    console.log("问题流程>>>>>>>>>>>>>>>>>" + processKey+">>>>>>>>"+businessKey);
    ...
    ...mapActions([
     ...
     async runQueryBusinessInfoByKeyApi() {
      ...
      if (result.meta.success == true) {
        ...
        this.issuesInfoList = returnMap.businessKeyDetail;
        this.$store.commit('updatFormDetail',this.issuesInfoList);
      }else{
      ...
      handleSumbitWorkOrderTaskClick(){
        let item=this.issuesInfoList[0];
