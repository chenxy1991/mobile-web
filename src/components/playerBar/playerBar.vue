        ...
        <div class="player-mini">
            <div class="mini-content">
                <audio :src="audio.location" @timeupdate="updateTime" @canplay="canPlaySong" @error="loadError"
                       @ended="next" id="audioPlay"></audio>
                <div class="music-logo">
                    <img v-lazy="audio.albumPic + '?param=100y100'" lazy="loading" v-show="!loading" :alt="audio.name"
                         @click="showDetail">
                </div>
                <div class="info">
                ...
                <div class="mini-option">
                    ...
                    <div style='width:40px;height:40px;'>
                        <x-circle :percent="prCurrentTime" :stroke-width="5" stroke-color="#ce332e"
                                  trail-color="#d1d1d1">
